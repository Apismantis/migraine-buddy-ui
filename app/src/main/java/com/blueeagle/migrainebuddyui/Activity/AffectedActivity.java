...
public class AffectedActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.btnBotherLater:
                Intent intent = new Intent(AffectedActivity.this, MyRecordActivity.class);
                startActivity(intent);
                finish();
                break;

            case R.id.btnNext:
                Intent intent1 = new Intent(AffectedActivity.this, LocationActivity.class);
